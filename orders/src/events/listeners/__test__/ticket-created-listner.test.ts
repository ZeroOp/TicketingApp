import { TicketCreatedEvent } from "@zeroop-dev/common";
...
const setup = async () => {
    // create an instanc eof the instance
...
it('creates and saves a ticket', async () => {
    ...
    // call the onMessage functionw itht hte data object + message object
...
it('acks the message', async () => {
    ...
    // call the onMessage functionw itht hte data object + message object
    await listner.onMessage(data,msg);
    // write assertison to make sure ack function is called
